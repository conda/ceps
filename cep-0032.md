...
<tr><td> Requires </td><td>CEP 29, CEP 33, CEP 34 </td></tr>
</table>
...
The rest of the environment is generally populated by the contents of its installed packages, after extraction and linking. As a result, the structure is arbitrary and determined by which packages are installed. Refer to [CEP 34](./cep-0034.md) for more details on which conventions to follow.
