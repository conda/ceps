# CEP 40 - A new recipe format (part 4): Rendered recipe YAML and serialization

<table>
<tr><td> Title </td><td> A new recipe format (part 4): Rendered recipe YAML and serialization </td>
<tr><td> Status </td><td> Accepted </td></tr>
<tr><td> Author(s) </td><td> Wolf Vollprecht &lt;wolf@prefix.dev&gt;</td></tr>
<tr><td> Created </td><td> Apr 13, 2024</td></tr>
<tr><td> Updated </td><td> Apr 17, 2026</td></tr>
<tr><td> Discussion </td><td> https://github.com/conda/ceps/pull/74 </td></tr>
<tr><td> Implementation </td><td>https://github.com/prefix-dev/rattler-build</td></tr>
</table>

## Abstract

Part of the effort to strictly define a new recipe format. The previous CEPs are:

- [CEP 13: A new recipe format](./cep-0013.md)
- [CEP 14: A new recipe format (part 2): allowed keys and values](./cep-0014.md)
- [CEP 39: A new recipe format (part 3): `jinja` functions in recipes](./cep-0039.md)
...
- `source`: The dependency comes from the recipe.
...
> The `sha256` field is added if it is not already present in the source
...
use_gitignore: # optional bool whether to use the .gitignore file when copying a directory
```
