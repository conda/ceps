# CEP 39 - A new recipe format (part 3): `jinja` functions in recipes

<table>
<tr><td> Title </td><td> A new recipe format (part 3): `jinja` functions in recipes </td>
...
The v0 recipe format has allowed arbitrary Jinja syntax (including set,
