...
Channel subdir names MUST only consist of lowercase ASCII letters, numbers, hyphens, underscores and periods. They MUST start and end with a letter or a number. They MUST NOT contain two consecutive separators (hyphen, underscore, period). They MUST match this regex: `^[a-z0-9]+((-|_|.)[a-z0-9]+)*$`.
